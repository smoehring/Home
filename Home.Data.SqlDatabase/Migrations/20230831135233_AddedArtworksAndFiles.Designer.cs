...
namespace Smoehring.Home.Data.SqlDatabase.Migrations
{
    ...
    [Migration("20230831135233_AddedArtworksAndFiles")]
    partial class AddedArtworksAndFiles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtworkArtworkSet", b =>
                {
                    b.Property<int>("ArtworkSetsId")
                        .HasColumnType("int");

                    b.Property<int>("ArtworksId")
                        .HasColumnType("int");

                    b.HasKey("ArtworkSetsId", "ArtworksId");

                    b.HasIndex("ArtworksId");

                    b.ToTable("ArtworkArtworkSet");
                });
            ...
            modelBuilder.Entity("Smoehring.Home.Data.SqlDatabase.Models.ArtworkSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArtworkArtworkSet", b =>
                {
                    b.HasOne("Smoehring.Home.Data.SqlDatabase.Models.ArtworkSet", null)
                        .WithMany()
                        .HasForeignKey("ArtworkSetsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
